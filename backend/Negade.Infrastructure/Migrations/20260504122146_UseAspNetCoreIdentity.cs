...
{
    /// <inheritdoc />
    public partial class UseAspNetCoreIdentity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("""
                ...
                SET
                    ...
                    "NormalizedUserName" = upper("PhoneNumber"),
                ...
                VALUES
                    ('11111111-1111-1111-1111-111111111111', 'Admin', 'ADMIN', md5(random()::text || clock_timestamp()::text)),
                    ('22222222-2222-2222-2222-222222222222', 'Trader', 'TRADER', md5(random()::text || clock_timestamp()::text))
                ...
                SELECT
                    "Id",
                    CASE
                        WHEN "Role" = 'Admin' THEN '11111111-1111-1111-1111-111111111111'::uuid
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Quotes_AspNetUsers_SupplierUserId",
                table: "Quotes",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Rfqs_AspNetUsers_BuyerUserId",
                table: "Rfqs",
                column: "BuyerUserId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_TradeRatings_AspNetUsers_RaterUserId",
                table: "TradeRatings",
                column: "RaterUserId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "AppUsers",
                newName: "IX_AppUsers_PhoneNumber");
